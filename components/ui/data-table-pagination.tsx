  ...
  return (
    <div className="flex items-center justify-between px-2 space-x-2 py-4">
      <div className="flex-1 text-sm text-muted-foreground">
        {table.getFilteredSelectedRowModel().rows.length} od {table.getFilteredRowModel().rows.length} kolone(a) označeno.
      </div>
      <div className="flex items-center space-x-6 lg:space-x-8">
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            <span className="sr-only">Idi na narednu stranicu</span>
          ...
          <Button
            ...
            disabled={!table.getCanNextPage()}
          >
            <span className="sr-only">Idi na posljednju stranicu</span>
